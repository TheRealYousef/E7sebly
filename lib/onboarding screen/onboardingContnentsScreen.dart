...
List<OnboardingContents> contents = [
  OnboardingContents(
    ...
    desc: "كل عمليات الحسابيه بقت دلوقتي في مكان واحد وسهل الوصول ليها بدوسه واحده بس",
  ),
  OnboardingContents(
    title: "المعدل التراكمي ",
    image: "assets/img/icons/onboarding_2.png",
    desc:
    "تقدر تحسب معدلك التراكمي علي حسب جامعتك والمواد بتاعتك  ",
  ),
  OnboardingContents(
    title: "كتله الجسم وغيرها",
    image: "assets/img/icons/onboarding_3.png",
    desc:
    " دلوقتي تقدر تحسب كتله جسمك وهنقولك معلومات تفيدك صحيا",
  ),
  OnboardingContents(
